...
class FyleAuthorization(View):
            ...
            if user is not None:
                ...
                if fyle_user is not None:
                    ...
                    with transaction.atomic():
                        # Create user
                        user = self.create_user(slack_client, slack_team, state_params['user_id'], slack_user_dm_channel_id, fyle_refresh_token, fyle_profile['user_id'], fyle_profile['org_id'])
    ...
    def create_user(self, slack_client: WebClient, slack_team: Team, user_id: str, slack_user_dm_channel_id: str, fyle_refresh_token: str, fyle_user_id: str, fyle_org_id: str) -> User:
