...
def get_report_expenses_dialog(user: User, report: dict, private_metadata: str, report_expenses: dict) -> Dict:
    ...
    if report is None and report_expenses is None:
            ...
            'blocks': [
                {
                    ...
                    'fields': [
                        {
                            'type': 'mrkdwn',
                            'text': '*Loading report ...* :hourglass_flowing_sand:'
                        }
                    ]
                }
            ]
        ...
        if report is not None and report_expenses is None:
            ...
            ### Show report info. and expenses list
