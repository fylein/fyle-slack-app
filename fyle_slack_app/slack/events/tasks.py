...
from fyle_slack_app.slack.utils import get_slack_user_dm_channel_id, get_slack_client, get_file_content_from_slack
...
def handle_file_shared(file_id: str, user_id: str, team_id: str):
    ...
    # i.e. data extraction flow
        ...
        de_response = FyleExpense.extract_data_from_file(de_payload, user.fyle_refresh_token)

        print('DE RESPOSE -> ', de_response)
